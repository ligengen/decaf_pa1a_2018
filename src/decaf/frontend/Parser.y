...
LValue          :	Receiver IDENTIFIER
                ...
                |   VAR IDENTIFIER
                    {
                        $$.lvalue = new Tree.Ident($2.ident, $2.loc, true);
                    }
                ;
...
Expr            :	LValue
                ...
                |   Expr INITARRAY Expr
                    {
                        $$.expr = new Tree.ArrayRepeat($2.loc, $1.expr, $3.expr);
                    }
                ...
                |   Expr '[' Expr ']' DEFAULT Expr
                    {
                        $$.expr = new Tree.DynamicAccess($5.loc, $1.expr, $3.expr, $6.expr);
                    }
...
ForeachStmt     :   FOREACH '(' BoundVariable IN Expr ')' Stmt
                ...
                |   FOREACH '(' BoundVariable IN Expr WHILE Expr ')' Stmt
                    {
                        $$.stmt = new Tree.Foreach($1.loc, $3.type, $3.ident, $5.expr, $7.expr, $9.stmt);
                    }
                ;
