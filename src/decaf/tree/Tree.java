...
public abstract class Tree {
    ...
    public static class Ident extends LValue {
        ...
        public Ident(String name, Location loc, boolean var) {
            super(IDENT, loc);
            this.name = name;
            this.var = var;
        }
    ...
    public static class Scopy extends Tree {
        ...
        public Scopy(String idName, Expr instance, Location loc) {
            super(SCOPY, loc);
            this.idName = idName;
            this.instance = instance;
        }
    ...
    public static class ArrayRepeat extends Expr {
        ...
        public ArrayRepeat(Location loc, Expr expr, Expr intconst){
    ...
    public static class DynamicAccess extends Expr {
        ...
        public DynamicAccess(Location loc, Expr _1, Expr _2, Expr _3) {
    ...
    public static class Foreach extends Tree {
        ...
        public Foreach(Location loc, TypeLiteral type, String name, Expr _1, Expr _2, Tree stmt) {
            super(FOREACH, loc);
            this.var_ = name;
            this._1 = _1;
            this._2 = _2;
